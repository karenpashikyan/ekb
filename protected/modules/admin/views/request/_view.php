...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('master_name')); ?>:</b>
	<?php echo CHtml::encode($data->master_name); ?>
	<br />
...
<b><?php echo CHtml::encode($data->getAttributeLabel('time_start')); ?>:</b>
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('time_finish')); ?>:</b>
	<?php echo CHtml::encode($data->time_finish); ?>
	<br />
