...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'discription',array('size'=>50,'maxlength'=>50)); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'long_discription'); ?>
	...
	<div class="row">
		<?php echo $form->label($model,'short_discriptio'); ?>
